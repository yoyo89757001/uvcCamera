 ...
 //   private static final String authIP = "https://api-cn.faceplusplus.com";
    ...
    private class RecognizeThread extends Thread {
        ...
        public void run() {
            while (!isInterrupt) {
                try {
                    Log.d("ffffff", "2 mDetectResultQueue.size = " + mDetectResultQueue.size());
    ...
    private void initView() {
        ...
        LineChart lineChart= (LineChart) findViewById(R.id.tubiao);
        BarChart barChart= (BarChart) findViewById(R.id.tubiao2);
        ...
        for (int i=0;i<15;i++){
            BarEntry entry=new BarEntry(i*2,i+2);
...
//
//
//        BarDataSet dataSet2 = new BarDataSet(barEntries, "Label"); // add entries to dataset
//        dataSet2.setColor(Color.CYAN);
//        dataSet2.setValueTextColor(Color.YELLOW); // styling, ...
//
...
//        barChart.invalidate();
        ...
        ruku.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("MainActivity2", "ddddddddddd");

                dialog=new JiaZaiDialog(MainActivity2.this);
                dialog.show();
...
//                                out.close();
        ...
        dw = Utils.getDisplaySize(MainActivity2.this).x;
        dh = Utils.getDisplaySize(MainActivity2.this).y;
        manager = new CameraManager();
        cameraView = (CameraPreview) findViewById(R.id.preview);
      //  cameraView.setScale(4,3);
        ...
        FrameLayout.LayoutParams params2= (FrameLayout.LayoutParams) faceView.getLayoutParams();
        params2.width=dw;
        params2.height=dh/3;
    ...
    private void showFacePassFace(FacePassFace[] detectResult) {
        ...
        for (FacePassFace face : detectResult) {
            ...
            faceView.setViewWH(faceView.getMeasuredWidth(),faceView.getMeasuredHeight());
        }
        faceView.invalidate();
    }
