    ...
    private void initView() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!userInfoBena.getCertNumber().equals("")&& !fanghao.getText().toString().trim().equals("")){
                    try {
                       // isBaoCun=true;
                        link_save();
                    ...
                    Toast tastyToast= TastyToast.makeText(XinJiangActivity.this,"请填写房号再保存.",TastyToast.LENGTH_LONG,TastyToast.ERROR);
                    tastyToast.setGravity(Gravity.CENTER,0,0);
                    tastyToast.show();
                }
