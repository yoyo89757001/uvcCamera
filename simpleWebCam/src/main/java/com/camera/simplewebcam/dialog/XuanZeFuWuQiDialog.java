package com.camera.simplewebcam.dialog;
...
import com.camera.simplewebcam.view.MyEditText;
 ...
 * @author Tom.Cai
 */
public class XuanZeFuWuQiDialog extends Dialog {
    private TextView title2;
    private Button l1,l2;
    private MyEditText shanchu;
    public XuanZeFuWuQiDialog(Context context) {
        super(context, R.style.dialog_style2);
        setCustomDialog();
    }

    private void setCustomDialog() {
        View mView = LayoutInflater.from(getContext()).inflate(R.layout.xiugaidialog2, null);
